...
Frozen World е платформска игра. Идејата потекнува од играта [Jack Frost]( http://www.nitrome.com/games/jackfrost/#.XRno5-j_xPa) од Nitrome. Во мојата имплементација на играта – како и во оригиналната игра постои можност за single player и multi player игра.
...
```
- При log in на корисник кој веќе игра, истиот се чита од меморија со OpenFile.
```csharp
